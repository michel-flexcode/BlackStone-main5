...
INSERT INTO `companies` (`id`, `name`, `web`, `mail_domain`, `logo`) VALUES
...
CREATE TABLE `reports` (
  ...
  `id_company_auditada` int(11) DEFAULT NULL,
...
INSERT INTO `reports` (`id`, `name_doc`, `id_company_auditada`, `vulnerabilidades`, `estado`, `fecha`, `recommendations`, `propuestas`, `conclusiones`) VALUES
...
INSERT INTO `scope_vulnerabilidades` (`id_vulnerabilidad`, `descripcion`, `nivel`, `id`, `name`, `id_scope`, `solucion`) VALUES
...
INSERT INTO `usuarios` (`id`, `name`, `contra`) VALUES
(1, 'blackstone5', '$2y$10$eWlAFAHveUj4.WGy/2xCuOWXYAaVHe6PU3C8PN/reEdKQU69QRDlC');
...
INSERT INTO `vulnerabilidades` (`id`, `descripcion`, `solucion`, `nivel`, `name`) VALUES
...
(197, 'Aprovecha las debilidades en las implementaciones para las connectiones OAuth y OpenID', 'Seguir las mejores prácticas de seguridad para la integración de las connectiones de OAuth y OpenID', 3, 'Vulnerabilidades en las connectiones de OAuth y OpenID'),
