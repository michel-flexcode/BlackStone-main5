...
<html>
  <head>
    ...
    <title>blackstone5 - <?php echo lang("Customers");?></title>
    <!-- plugins:css -->
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table" id="tabla_listado_cve">
                        ...
                        $consulta = mysqli_query($connection, $sentencia) or die("Error de conexión en tabla companies");
                        ...
                        while($file= mysqli_fetch_array($consulta)){
                                ...
                                $mail_domain=htmlspecialchars($file['mail_domain'], ENT_QUOTES | ENT_HTML5, 'UTF-8');
                                $logo=$file['logo'];
