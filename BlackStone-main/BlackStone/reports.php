                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table" id="tabla_listado_cve">
                        ...
                        $sentencia = "select * from reports order by id";    
                        ...
                        while($file= mysqli_fetch_array($consulta)){
                                ...
                                $consulta_company = mysqli_query($connection, $sentencia_company) or die("Error de conexión en tabla vulnerabilidades");

                                while($file_company= mysqli_fetch_array($consulta_company)){
                                  $name_company_auditada=$file_company['name'];
                                }
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><?php echo $name_company_auditada?></td>
