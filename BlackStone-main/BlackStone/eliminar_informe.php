                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php
                      ...
                      $consulta_cantidad = mysqli_query($connection, $sentencia_cantidad) or die("Error de Consulta");

                      $numero = 0;

                      while($file_cantidad = mysqli_fetch_array($consulta_cantidad)){

                        $id_scope = $file_cantidad['id'];
                        $numero = $numero +1;
                      }
                      ...
                      if($numero >= 1){
                        ...
                        $sentencia = "DELETE FROM `reports` WHERE id=".$id_url;    
                    ...
                    <a class="nav-link btn btn-info col-lg-1 col-12 create-new-button" aria-expanded="false" href="reports.php"><?php echo lang("Return");?></a>
                  </div>
                </div>
              </div>
            </div>
