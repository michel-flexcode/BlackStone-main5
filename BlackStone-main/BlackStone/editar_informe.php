...
<html>
  <head>
    ...
    <title>blackstone5 - <?php echo lang("Reports");?></title>
    <style>
        .contenedor {
          width: 300px;
          margin: 20px auto;
        ...
        <div class="main-panel">
          ...
          <?php
                ...
                while($file= mysqli_fetch_array($consulta)){
                  ...
                  $vulnerabilidades=$file['vulnerabilidades'];
                  $estado=$file['estado'];
                  $fecha=$file['fecha'];
                  $recommendations=$file['recommendations'];
                  $propuestas=$file['propuestas'];
                  $conclusiones0=$file['conclusiones'];

                  $sentencia_company = "select * from companies where id=".$id_company_auditada;
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-8">
                              <select class="form-control" id="id_company_auditada" style="color:white" name="id_company_auditada" required>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                      ...
                                      while($file_vulns_asset = mysqli_fetch_array($consulta_vulns_asset)){
                                        ...
                                        $descripcion=htmlspecialchars($file_vulns_asset['descripcion'], ENT_QUOTES | ENT_HTML5, 'UTF-8');
                                        $nivel=$file_vulns_asset['nivel'];
                                        ...
                                        ?>
                                            ...
                                            <?php
                                              ...
                                              while($file_vulns = mysqli_fetch_array($consulta_vulns)){
                                                    ...
                                                    $descripcion=htmlspecialchars($file_vulns['descripcion'], ENT_QUOTES | ENT_HTML5, 'UTF-8');
                                                    $nivel=$file_vulns['nivel'];
            ...
            <?php
                ...
                if (isset($_POST['guardar_cambios_informe'])){
                  ...
                  $id_company_auditada = $_POST['id_company_auditada'];
                  $fecha = $_POST['fecha'];
                  $estado = $_POST['estado'];
                  $conclusiones = $_POST['conclusiones'];

                  $sentencia = "UPDATE `reports` set `name_doc`='$name_doc',";
                  $sentencia .="`id_company_auditada`='$id_company_auditada',";
                  ...
                  $id_scope = $_POST['insertar_vuln_scope'];
                   ...
                   foreach($_POST['vuln'] as $selected){
                       ...
                       while($file_vuln_asset = mysqli_fetch_array($consulta_vuln_1)){
                           $id_vulnerabilidad=$file_vuln_asset['id'];
                           $name=$file_vuln_asset['name'];
                           $descripcion=$file_vuln_asset['descripcion'];
                           $solucion=$file_vuln_asset['solucion'];
                           $nivel=$file_vuln_asset['nivel'];
                       }
                       ...
                       $sentencia_insertar_vuln_asset = "INSERT INTO `scope_vulnerabilidades`(`id`, `id_vulnerabilidad`, `name`, `descripcion`, `nivel`, `id_scope`, `solucion`)";
                       $sentencia_insertar_vuln_asset .= "VALUES ('$ultimo_id_scope','$id_vulnerabilidad','$name','$descripcion','$nivel', '$id_scope', '$solucion')";
