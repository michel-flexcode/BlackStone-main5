  ...
  <body>
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        ...
                        <?php
                          ...
                          $consulta = mysqli_query($connection, $sentencia) or die("Error de conexión en tabla vulnerabilidades");
                          $_vulnerabilidades = 0;
                          ...
                          ?>
                          <h2 class="mb-0"><?php echo $_vulnerabilidades;?></h2>
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php
                      ...
                      $sentencia_infor = "select * from reports order by fecha limit 2";  
                      ...
                      while($file_infor = mysqli_fetch_array($consulta_infor)){
                        ...
                        $vulnerabilidades=$file_infor['vulnerabilidades'];
                        $name_doc=$file_infor['name_doc'];
                        $fecha_proy=$file_infor['fecha'];
                          ...
                          <center>
                            <div class='d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3' style='background: #12151e; width:350px'>
                              <div class='text-md-center text-xl-left'>
                                <h6 class='mb-1'><a class='text-decoration-none text-white' href='editar_informe.php?id=".$id_infor."'>".$name_doc."</a></h6>
                        ...
                        <div class="preview-list">
                            ...
                            <?php
                              ...
                              while($file3= mysqli_fetch_array($consulta)){
                                  ...
                                  $sentencia_infor = "select * from reports where id_company_auditada=".$id_company;  
                                  $consulta_infor = mysqli_query($connection, $sentencia_infor) or die("Error de conexión");
    ...
    <?php
            ...
            while($file_vulns = mysqli_fetch_array($consulta_vulns)){
                ...
                $gravedad_vuln = $file_vulns['nivel'];
