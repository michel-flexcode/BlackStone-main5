...
<html>
  <head>
    ...
    <title>blackstone5 - <?php echo lang("Companies");?></title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="page-header">
              <h3 class="page-title"> <?php echo lang("Seguimos mejorando blackstone5"); ?> </h3>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul>
                      <li>Instalador propio y automatizado para despliegue de blackstone5 en Kali Linux</li>
                      ...
                      <li>Limitación de acceso a la app blackstone5 únicamente al equipo que la ejecuta (nadie en tu red que detecte tu puerto 80 levantado podrá acceder a esta app).</li>
                      ...
                      <li>Búsqueda de subdominios automática en la ficha de cliente, dicha funcionalidad es nativa del propio código de blackstone5).</li>
                      <li>Solucionadas diversas traducciones español/inglés.</li>
                      <li>Integración de icono del sistema para blackstone5, se añade la aplicación en Kali como una aplicación nativa con su propio lancuher.</li>
